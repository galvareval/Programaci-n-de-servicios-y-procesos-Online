...
private static Conexiones conex;
  /**
   * **************************************************************************
  ...
  public static void main(String[] args) throws IOException, Exception 
  {
    ...
    while (true) {
      ...
      //Iniciar conexion, se procesara la petición en la clase conexión
      conex = new Conexiones(socCliente);
      conex.start();
    }
  }
   ...
   * @return 
   */
  public static String cabeceraDAte()
  {
      String formato = "EEE, d MMM yyyy HH:mm:ss z";
      DateFormat formatoFecha = new SimpleDateFormat(formato, Locale.ENGLISH);
